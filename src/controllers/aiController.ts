...
export const chat = async (
  ...
  try {
    ...
    const systemPrompt = [
      ...
      'When returning a structured training plan with modules, append a dynamic style blueprint generated by Claude using this exact tag format:',
      '<harx-style>{"moduleCardThemes":[{"bg":"#hex","border":"#hex","text":"#hex"}],"titleColor":"#hex","accentColor":"#hex"}</harx-style>',
      'Choose colors dynamically according to the response context. Return valid JSON inside the tag.',
