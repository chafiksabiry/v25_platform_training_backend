...
export const chat = async (
  ...
  try {
    ...
    const systemPrompt = [
      ...
      'When returning pedagogical content, append a dynamic style blueprint generated by Claude using this exact tag format:',
      ...
      'Generate colors, table style, and card shape dynamically from the context. Return valid JSON inside the tag.',
